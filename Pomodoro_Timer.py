...
def Timer_Start():
    timer_start = threading.Timer(10.0,First_Study_Sesh) # after 10 seconds function First_Study_Sesh will run
    timer_start.start()

    timer_start_1 = threading.Timer(15.0, Second_Study_Sesh) # after 15 seconds function Break_Five will run
    timer_start_1.start()

    timer_start_2 = threading.Timer(25.0, Third_Study_Sesh) # after 25 seconds function Third_study_sesh will run
    timer_start_2.start()

    timer_start_3 = threading.Timer(30.0, Fourth_Study_Sesh) # after 15 seconds function Fourth_study_sesh will run 
    timer_start_3.start()

    timer_start_4 = threading.Timer(40.0, Fifth_Study_Sesh)
    timer_start_4.start()

    timer_start_5 = threading.Timer(45.0, Sixth_Study_Sesh)
    timer_start_5.start()
# Lables
